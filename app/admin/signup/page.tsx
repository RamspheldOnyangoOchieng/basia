      ...
      <div className="w-full max-w-md">
        <div className="bg-[#1A1A1A] rounded-xl p-8 shadow-lg">
          ...
          <div className="mt-6 p-4 bg-blue-900/20 border border-blue-800 text-blue-300 rounded-lg">
            ...
            <Link href="/admin/manual-setup" className="text-[#FF4D8D] hover:underline flex items-center text-sm">
          ...
          <div className="mt-6 text-center text-sm">
            <p className="text-gray-400">
              ...
              <Link href="/admin/login" className="text-[#FF4D8D] hover:underline">
                Log in
              </Link>
            </p>
          </div>
