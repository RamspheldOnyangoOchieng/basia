            ...
            <CardContent className="p-6">
              <div className="space-y-4">
                ...
                <Button
                  ...
                  className="w-full bg-[#FF4D8D] hover:bg-[#FF3D7D] mt-2"
                >
                  {isGenerating ? (
                    <>
            ...
            <CardContent className="p-6">
                ...
                {isGenerating ? (
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="text-center">
                      <Loader2 className="h-12 w-12 animate-spin mx-auto mb-4 text-[#FF4D8D]" />
              ...
              <div className="flex gap-2">
                ...
                <Button
                  ...
                  className="flex-1 bg-[#FF4D8D] hover:bg-[#FF3D7D]"
                >
