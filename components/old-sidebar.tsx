...
export default function Sidebar() {
  ...
  return (
    <div
      className={`fixed inset-y-0 left-0 z-50 w-64 bg-[#1A1A1A] border-r border-[#252525] transition-transform duration-300 ease-in-out ${
      ...
      <div className="flex flex-col h-full">
        ...
        <div className="p-4 border-b border-[#252525] flex items-center justify-between">
          <Link href="/" className="flex items-center">
            ...
            <span className="text-xl font-bold text-[#FF4D8D]">.ai</span>
          </Link>
